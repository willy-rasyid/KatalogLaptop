...
public class GaleriAktivity extends AppCompatActivity {
    ...
    TextView txDeskripsi,txJenis,txJudul, txType;
    ImageView ivFotoLaptop;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_galeri_aktivity);
